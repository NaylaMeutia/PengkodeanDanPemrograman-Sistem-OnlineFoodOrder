...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/logo1fixxx.png" sizes="32x32">
  <!-- Favicons-->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/logo1fixxx.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Menu Makanan</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Order</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">Semua Order</a>
                                </li>
								<?php
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tiket</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-tickets.php">Semua Tiket</a>
                                </li>
								<?php
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Pengguna</a>
            </li>				
        </ul>
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2004 <a class="grey-text text-lighten-4" href="#" target="_blank">Nayla Meutia</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Nayla Meutia</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
